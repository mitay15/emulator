...
def generate_future_iob(iob_now: Optional[IobTotal],
                        params: Optional[InsulinCurveParams] = None) -> List[IobTotal]:
    ...
    base_time = getattr(iob_now, "timestamp", None) or getattr(iob_now, "time", None) or 0
