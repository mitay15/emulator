...
def main():
    ...
    for idx in to_check:
        ...
        print(f"idx {idx}: ref_ev={ref['aaps_eventual']} py_ev={res.eventualBG} ev_ok={ev_ok} rate_ref={ref['aaps_rate']} py_rate={res.rate} rate_ok={rate_ok} ins_ref={ref['aaps_insreq']} py_ins={res.insulinReq} ins_ok={ins_ok}")
